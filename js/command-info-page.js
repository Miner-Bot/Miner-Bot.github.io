...
const prefix = '=';
	...
	if (found.usage && found.aliases) {
		str = 'Description:' + ' ' + found.description + '<br>' + 'Usage:' + ' ' + prefix + found.name + ' ' + found.usage + '<br>' + 'Aliases:' + ' ' + prefix + found.aliases;
	} else if (found.usage && !found.aliases) {
		str = 'Description:' + ' ' + found.description + '<br>' + 'Usage:' + ' ' + prefix + found.name + ' ' + found.usage;
	} else if (!found.usage && found.aliases) {
		str = 'Description:' + ' ' + found.description + '<br>' + 'Usage:' + ' ' + prefix + found.name + '<br>' + 'Aliases:' + ' ' + prefix + found.aliases;
	} else if (!found.usage && !found.aliases) {
		str = 'Description:' + ' ' + found.description + '<br>' + 'Usage:' + ' ' + prefix + found.name;
	}
