...
module.exports = {
	...
	execute(message) {
		if (message.author.id === '444767734409068545') {
			...
			fs.readFile('C:/Users/mjsey/MinerBot/MinerBot/Miner-Bot.github.io/MinerBot/Users.json', (err, data) => {
				if (err) throw err;
				...
				fs.readFile('C:/Users/mjsey/MinerBot/MinerBot/Miner-Bot.github.io/MinerBot/numbers.json', (err, data2) => {
					if (err) throw err;
